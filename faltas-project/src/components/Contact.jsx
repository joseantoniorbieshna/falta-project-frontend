        ...
        <div className="p-8">
          ...
          <div className="flex justify-center mt-6">
            ...
            <a href="mailto:youjoserb1@gmail.com" className="text-gray-500 hover:text-gray-800 mx-2">
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 12.713l11.64-7.772c-.159-.098-4.944-3.199-11.64-3.199-6.696 0-11.482 3.101-11.64 3.199L12 12.713zm11.64-1.671c-.328.207-4.944 3.199-11.64 3.199s-11.313-2.992-11.64-3.199v11.104h23.28V11.042z" />
              </svg>
            </a>
          </div>
        </div>
